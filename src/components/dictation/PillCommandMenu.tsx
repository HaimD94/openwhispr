...
export function PillCommandMenu({
  ...
  return (
    <div
      ref={menuRef}
      className={`absolute ${verticalPosition} ${horizontalAnchor} w-48 overflow-hidden rounded-lg border border-border bg-popover text-popover-foreground shadow-lg backdrop-blur-sm`}
      onMouseEnter={() => {
